...
const handleErrors = () => {
    ...
    if (amountOfErrors > 0) {
        console.log('> Viking Icons Theme 🛡️⚔️:', painter.red(`Found ${amountOfErrors} error(s) in the icon configuration!`));
    } else {
        console.log('> Viking Icons Theme 🛡️⚔️:', painter.green('Passed icon availability checks!'));
    }
