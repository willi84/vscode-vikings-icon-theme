...
const handleErrors = () => {
    ...
    if (amountOfUnusedIcons === 0) {
        console.log('> Viking Icons Theme 🛡️⚔️:', painter.green('Passed icon usage checks!'));
    } else {
        console.log('> Viking Icons Theme 🛡️⚔️: ' + painter.red(`${amountOfUnusedIcons} unused icon(s):`));
